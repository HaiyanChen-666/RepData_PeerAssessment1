...
# Set global options
knitr::opts_chunk$set(echo = TRUE, results = "hide", message = FALSE, warning = FALSE, fig.path="figure/")
```
...
```{r Comparison-original-and-computed-data, fig.width=6, fig.height=8}
